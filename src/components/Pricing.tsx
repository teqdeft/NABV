...
const plans = [
  {
    ...
    features: [
      ...
      "Unlimited Behavioral Health visits",
      "Unlimited TeleVet consults",
      "1 member covered",
    ...
    >
      <div className="container-main">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 id="pricing-heading" className="text-3xl lg:text-4xl font-bold leading-tight text-foreground mb-4">
            NABV-negotiated member rates
          </h2>
          <p className="text-lg text-gray-600 mb-6">
            Your association secured exclusive pricing. No hidden fees. No contracts.
          </p>
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <div className="text-center mb-8">
                <h3 className="text-lg font-semibold text-gray-600 mb-2">{plan.description}</h3>
                <h4 className="text-2xl font-bold text-foreground mb-1">{plan.name}</h4>
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-gray-500 max-w-2xl mx-auto">
            <strong>Promo code: NABV000</strong> — Applied automatically when you unlock below.
            Code is also emailed for recovery. Enter it at checkout on app.iwilltilimwell.com/register.
          </p>
        </div>
      </div>
    </section>
